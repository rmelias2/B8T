...
# All Patients ####
#BCGS 
plot_and_save_density(data = data, x = "b_cell", outputname = "b_cell_densityplot", xlabname = "BCSG")
...
#BCGS
plot_and_save_density(data = df, x = "b_cell", outputname = "ctdnaPos_b_cell_densityplot", xlabname = "BCSG")
...
#BCGS
plot_and_save_density(data = df, x = "b_cell", outputname = "ctdnaNegative_b_cell_densityplot", xlabname = "BCSG")

#CD8GS
plot_and_save_density(data = df, x = "t_cell", outputname = "ctdnaNegative_t_cell_densityplot", xlabname = "CD8GS")
